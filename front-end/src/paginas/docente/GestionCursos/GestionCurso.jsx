...
const GestionCurso = () => {
  ...
  const [showPracticaForm, setShowPracticaForm] = useState(false);  const [videoTitle, setVideoTitle] = useState("");
  ...
  const handleCrearPractica = (newPractica) => {
    const newResource = {
      type: "practica",
      title: newPractica.practicaTitle,
      description: newPractica.practicaDesc,
      code: newPractica.practicaCode,
      id: Date.now()
    };
