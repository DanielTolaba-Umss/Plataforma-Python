...
import "./CursosIntermedio.css"; // Asegúrate de tener este archivo CSS para estilos
...
const CursosIntermedio = () => {
  ...
  return (
    <div className="curso-container">
      <header className="curso-header">Curso Intermedio</header>
...
export default CursosIntermedio;
